...
const EnvieSuzano = () => {
  useEffect(() => {
    ...
    document.title = 'Yama Print - Envie seu arquivo (Suzano)';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 md:p-8 text-center border border-gray-100 relative overflow-hidden">
        ...
        <div className="space-y-4 mb-8">
          ...
          <a
            href="mailto:suzano@yamaprint.com.br?subject=Envio%20de%20Arquivo"
        ...
        <div className="space-y-4 text-sm text-gray-600 border-t border-gray-100 pt-6">
          <div>
            ...
            <p className="font-medium text-gray-700">11 4747-3883</p>
            <p className="text-gray-500 text-xs">suzano@yamaprint.com.br</p>
          </div>
